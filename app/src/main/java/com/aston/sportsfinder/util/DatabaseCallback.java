    ...
    public void insertTestData(GameDao gameDao, UserDao userDao, NotificationDao notificationDao) {
        asyncTaskExecutor.execute(() -> {
            ...
            if (gameDao.countGames() == 0) {
                gameDao.insertGame(new Game("Cricket", "Spain", "Poland", 4, 2, false, false, "County Ground", "Northampton", "Northamptonshire", "England", 52.2405, -0.9032, "15-01-2024", "10:00", "Sukhpal", "22", 18, "Beginner", "Cricket bats, Balls, Protective gear", "3 hours", "0.00", "Beginners welcome", false));

                gameDao.insertGame(new Game("Football", "Arsenal", "Newcastle", 1, 0, false, false, "Hyde Park", "London", "Greater London", "England", 51.507268, -0.165730, "15-01-2024", "14:00", "Sukhpal", "22", 20, "Intermediate", "Football, Jerseys, Shin Guards", "90 minutes", "0.00", "Standard football rules apply", false));
                gameDao.insertGame(new Game("Football", "England", "Newcastle", 2, 1, false, true, "Heaton Park", "Manchester", "Greater Manchester", "England", 53.533013, -2.262634, "15-01-2024", "12:00", "Sukhpal", "22", 22, "Intermediate", "Football, Jerseys, Shin Guards", "90 minutes", "0.00", "Standard football rules apply", false));
                gameDao.insertGame(new Game("Football", "Liverpool", "Barcelona", 3, 5, false, false, "Victoria Park", "Bath", "Somerset", "England", 51.3848, -2.3615, "15-01-2024", "16:00", "Sukhpal", "22", 20, "Intermediate", "Football, Jerseys, Shin Guards", "90 minutes", "0.00", "Standard football rules apply", false));

                gameDao.insertGame(new Game("Baseball", "England", "France", 3, 1, false, false, "Roundhay Park", "Leeds", "West Yorkshire", "England", 53.8375, -1.4994, "15-01-2024", "13:00", "Sukhpal", "18", 15, "Beginner", "Bats, Gloves, Helmets", "2 hours", "0.00", "Standard baseball rules apply", false));
                gameDao.insertGame(new Game("Baseball", "Germany", "Russia", 3, 2, false, false, "Cannon Hill Park", "Birmingham", "West Midlands", "England", 52.4521, -1.8923, "15-01-2024", "14:30", "Sukhpal", "18", 18, "Intermediate", "Bats, Gloves, Helmets", "2 hours", "0.00", "Standard baseball rules apply", false));

                gameDao.insertGame(new Game("Rugby", "USA", "France", 1, 4, false, false, "Eaton Park", "Norwich", "Norfolk", "England", 52.6308859, 1.297355, "15-01-2024", "13:00", "Sukhpal", "30", 25, "Intermediate", "Rugby ball, Cleats, Protective gear", "80 minutes", "0.00", "Standard rugby rules apply", false));
                gameDao.insertGame(new Game("Rugby", "PSG", "Valencia", 1, 3, false, false, "Sandy Park", "Exeter", "Devon", "England", 50.7256, -3.4717, "15-01-2024", "18:30", "Sukhpal", "30", 30, "Advanced", "Rugby ball, Cleats, Protective gear", "80 minutes", "0.00", "Competitive level", false));
