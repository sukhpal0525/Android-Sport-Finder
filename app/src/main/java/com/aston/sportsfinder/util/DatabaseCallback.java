...
public class DatabaseCallback extends RoomDatabase.Callback {
    ...
    public void insertTestData(GameDao gameDao) {
        gameDao.insertGame(new Game(1, "Football", "Team A", "Team B", 2, 3, false, false, "123 Broadway St", "Manhattan", "NY", "USA", 40.7831, -73.9712, "2023-10-20", "14:00"));
        gameDao.insertGame(new Game(2, "Football", "Team A", "Team B", 2, 3, false, true, "334 Furman St", "Brooklyn", "NY", "USA", 40.7006, -73.9946, "2023-10-21", "16:00"));
//        gameDao.insertGame(new Game(3, "Football", "Team A", "Team B", 2, 3, false, true, "11101 Corona Ave", "Queens", "NY", "USA", 40.7462, -73.8458, "2023-10-22", "17:00"));
